  ...
  <AuthLayout>
    <div class="p-6 space-y-10">
      <h1 class="text-2xl font-bold mb-4">
        Dashboard for {{ auth.user ? auth.user.organization.name : "error org name" }}
      </h1>
      ...
      <div class="grid grid-cols-3 gap-3">
            ...
            <CardContent>
              <div>
                <span
                  ...
                  {{ stats ? stats.total_users : "NULL" }}</span
                >
              </div>
              <div>
            ...
            <CardContent>
              <div>
                <span
                  ...
                  {{ stats ? stats.total_vendors : "NULL" }}</span
                >
              </div>
            </CardContent>
            <CardFooter class="flex flex-col gap-2">
              <RouterLink to="/vendors" class="w-full">
                <Button class="w-full"> View </Button>
              </RouterLink>
            </CardFooter>
          </Card>
        ...
        <div>
          <Card class="">
            ...
            <CardContent>
              <div>
                <span
                  ...
                  {{ stats ? stats.total_invoices : "NULL" }}</span
                >
              </div>
              <div>
                <span>Pending: {{ stats ? stats.invoices_pending : "NULL" }}</span>
              </div>
              <div>
            ...
            <CardFooter class="flex flex-col gap-2">
              <RouterLink to="/invoices" class="w-full">
                <Button class="w-full"> View </Button>
              </RouterLink>
            </CardFooter>
          </Card>
